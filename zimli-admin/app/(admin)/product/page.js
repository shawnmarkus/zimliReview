    ...
    <div>
      <div className="flex justify-between mt-12 mb-7">
        ...
        <div className="flex gap-3">
          <FilterButton options={options} lable={"Category"} />
          <FilterButton options={options} lable={"Sub-cat"} />
          <FilterButton options={options} lable={"Brand"} />
          <button className=" text-xs font-normal text-[#DC137B] border rounded border-[#DC137B] px-5" onClick={openModal}>
            Add New Product
          </button>
          <ButtonExport />
        </div>
      ...
      <div className="flex border-b border-[#0000004D] mb-7 py-4 pl-5  font-medium text-sm  ">
        ...
        <h3 className="w-[12.5%]">Product Id</h3>
        <h3 className="w-[12.5%]">Name</h3>
        <h3 className="w-[12.5%]">Category</h3>
        <h3 className="w-[25%]">Sub-category</h3>
        <h3 className="w-[12.5%]">Brand</h3>
        <h3 className="w-[6.25%]">Stock</h3>
        <h3 className="w-[12.5%]">Actions</h3>
      </div>
      <ProductList itemsPerPage={6} />
      {isModalOpen == true ? (
        <AddNewProductForm showModal={isModalOpen} closeModal={closeModal} />
      ) : null}
    </div>
  );
}
    ...
    <>
      {currentItems &&
        currentItems.map((item) => (
          <div className="flex hover:bg-[#FFEEFB] mb-5 py-4 rounded-lg border pl-5 border-[#F2F2F2] bg-[#FDFDFD] items-center">
            ...
            <h3 className="w-[12.5%] font-medium text-xs text-[#333]">Saree</h3>
            <h3 className="w-[25%] font-normal text-xs text-[#333]">
              Saree With Stitched Blouse
            </h3>
            <h3 className="w-[12.5%] font-normal text-xs text-[#333]">
              Tikhi Imli
            </h3>
            <h3 className="w-[6.25%] font-normal text-xs text-[#333]">11</h3>
